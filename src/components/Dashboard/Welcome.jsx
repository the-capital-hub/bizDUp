...
export default function WelcomeSection() {
	return (
		<div className="space-y-4">
			<h1 className="text-3xl font-bold">Welcome Back Meet Jain :)</h1>
			...
			<div className="bg-blue-100 rounded-xl p-6">
				<div className="flex items-start gap-4">
					...
					<div className="flex-grow">
						<h3 className="text-xl font-semibold">Jaydon Vetrovs</h3>
						<p className="text-gray-600 mt-1">
							As the Founder at Capital HUB, Man's all about building great
							start-ups from a simple idea.
						</p>
						<div className="flex gap-4 mt-2 text-sm">
							<span>+91 7569074791</span>
							<span>Jaydon.Vetrovs@gmail.com</span>
						</div>
					</div>
				</div>
			</div>

...
// 				}
// 			} else {
// 				// For sign in, we send OTP to the phone
...
// 		try {
// 			const dataToVerify = {
// 				email: authMode === "signup" ? email : undefined,
// 				phone: authMode === "signin" ? phone : undefined,
// 				otp: otpValue,
// 			};
...
// 				// If this is a signup flow, proceed to registration
// 				if (authMode === "signup") {
// 					// You might want to collect more info before registration
// 					// or you could proceed with login if this is a 2-step verification
// 				} else {
// 					// For login, we can proceed with the login mutation
// 					handleLogin();
// 				}
// 			}
// 		} catch (error) {
...
// 		try {
// 			// Assuming your backend expects these credentials
// 			const credentials = {
// 				phone: phone, // or email depending on your API
// 				otp: otpValue, // or password depending on your authentication flow
// 			};
...
// 				// You might use React Router's navigate here
// 			}
// 		} catch (error) {
